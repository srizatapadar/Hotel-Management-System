		...
		if(ae.getSource()==b1) {
			...
			try {
				...
				try {
					...
					String str1="update customer set room ='"+room+"'  , name = '"+name+"', status = '"+status+"' , deposit = '"+deposit+"' where room = '"+room+"'";
